...
class SeerAttnLlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        q_len, h_size = hidden_states.size()
...
class SeerAttnLlamaDecoderLayer(nn.Module):
    def __init__(self, config: SeerAttnLlamaConfig, layer_idx: int):
        ...
        self.self_attn = SeerAttnLlamaAttention(config=config, layer_idx=layer_idx)
...
class LlamaRotaryEmbedding(nn.Module):
    def __init__(self, config: SeerAttnLlamaConfig, device=None):
        super().__init__()
...
class SeerAttnLlamaPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, nn.Linear):
            ...
            module.weight.data.normal_(mean=0.0, std=std)
        elif isinstance(module, LlamaRMSNorm) or isinstance(module, RMSNorm):
